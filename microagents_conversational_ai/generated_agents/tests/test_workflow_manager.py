...
from workflow_manager import WorkflowManager, WorkflowManagerInput, WorkflowManagerOutput
...
class TestWorkflowManager:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-workflow-manager-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Workflow Manager"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, WorkflowManagerOutput)
        assert result.agent_name == "Workflow Manager"
...
def test_workflow_manager_performance():
