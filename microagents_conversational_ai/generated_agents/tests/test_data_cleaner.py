...
from data_cleaner import DataCleaner, DataCleanerInput, DataCleanerOutput
...
class TestDataCleaner:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-data-cleaner-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Data Cleaner"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DataCleanerOutput)
        assert result.agent_name == "Data Cleaner"
