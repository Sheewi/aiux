...
from threat_detector import ThreatDetector, ThreatDetectorInput, ThreatDetectorOutput
...
class TestThreatDetector:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-threat-detector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Threat Detector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ThreatDetectorOutput)
        assert result.agent_name == "Threat Detector"
...
class TestThreatDetectorIntegration:
    """Integration tests for ThreatDetector."""
...
def test_threat_detector_performance():
