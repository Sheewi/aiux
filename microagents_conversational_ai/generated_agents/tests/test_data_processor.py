...
from data_processor import DataProcessor, DataProcessorInput, DataProcessorOutput
...
class TestDataProcessor:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-data-processor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DataProcessorOutput)
        assert result.agent_name == "Data Processor"
