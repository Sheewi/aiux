"""
Test suite for WebsiteGenerator
...
from website_generator import WebsiteGenerator, WebsiteGeneratorInput, WebsiteGeneratorOutput

class TestWebsiteGenerator:
    """Comprehensive test suite for WebsiteGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-website-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Website Generator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, WebsiteGeneratorOutput)
        assert result.agent_name == "Website Generator"
...
def test_website_generator_performance():
