...
from script_executor import ScriptExecutor, ScriptExecutorInput, ScriptExecutorOutput

class TestScriptExecutor:
    """Comprehensive test suite for ScriptExecutor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-script-executor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Script Executor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ScriptExecutorOutput)
        assert result.agent_name == "Script Executor"
...
def test_script_executor_performance():
