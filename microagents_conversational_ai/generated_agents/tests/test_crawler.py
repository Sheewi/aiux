...
from crawler import Crawler, CrawlerInput, CrawlerOutput

class TestCrawler:
    """Comprehensive test suite for Crawler."""
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, CrawlerOutput)
        assert result.agent_name == "Crawler"
