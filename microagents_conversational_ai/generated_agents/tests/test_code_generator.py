...
from code_generator import CodeGenerator, CodeGeneratorInput, CodeGeneratorOutput

class TestCodeGenerator:
    """Comprehensive test suite for CodeGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-code-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, CodeGeneratorOutput)
        assert result.agent_name == "Code Generator"
...
def test_code_generator_performance():
