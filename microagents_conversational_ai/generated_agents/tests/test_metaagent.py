...
from metaagent import Metaagent, MetaagentInput, MetaagentOutput

class TestMetaagent:
    """Comprehensive test suite for Metaagent."""
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert result.agent_name == "MetaAgent"
...
def test_metaagent_performance():
