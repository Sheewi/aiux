...
from natural_language_processor import NaturalLanguageProcessor, NaturalLanguageProcessorInput, NaturalLanguageProcessorOutput

class TestNaturalLanguageProcessor:
    """Comprehensive test suite for NaturalLanguageProcessor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-natural-language-processor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Natural Language Processor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, NaturalLanguageProcessorOutput)
        assert result.agent_name == "Natural Language Processor"
...
class TestNaturalLanguageProcessorIntegration:
    """Integration tests for NaturalLanguageProcessor."""
...
def test_natural_language_processor_performance():
