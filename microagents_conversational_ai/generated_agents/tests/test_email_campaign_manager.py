"""
Test suite for EmailCampaignManager
...
from email_campaign_manager import EmailCampaignManager, EmailCampaignManagerInput, EmailCampaignManagerOutput

class TestEmailCampaignManager:
    """Comprehensive test suite for EmailCampaignManager."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-email-campaign-manager-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Email Campaign Manager"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, EmailCampaignManagerOutput)
        assert result.agent_name == "Email Campaign Manager"
...
class TestEmailCampaignManagerIntegration:
    """Integration tests for EmailCampaignManager."""
...
def test_email_campaign_manager_performance():
