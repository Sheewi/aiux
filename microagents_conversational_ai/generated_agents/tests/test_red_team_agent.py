...
from red_team_agent import RedTeamAgent, RedTeamAgentInput, RedTeamAgentOutput
...
class TestRedTeamAgent:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-red-team-agent-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert result.agent_name == "Red Team Agent"
...
def test_red_team_agent_performance():
