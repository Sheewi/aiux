...
from researcher import Researcher, ResearcherInput, ResearcherOutput

class TestResearcher:
    """Comprehensive test suite for Researcher."""
...
class TestResearcherIntegration:
    """Integration tests for Researcher."""
