...
from agent_generator import AgentGenerator, AgentGeneratorInput, AgentGeneratorOutput

class TestAgentGenerator:
    """Comprehensive test suite for AgentGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-agent-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Agent Generator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, AgentGeneratorOutput)
        assert result.agent_name == "Agent Generator"
...
class TestAgentGeneratorIntegration:
    """Integration tests for AgentGenerator."""
...
def test_agent_generator_performance():
