...
from data_analyzer import DataAnalyzer, DataAnalyzerInput, DataAnalyzerOutput

class TestDataAnalyzer:
    """Comprehensive test suite for DataAnalyzer."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-data-analyzer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Data Analyzer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DataAnalyzerOutput)
        assert result.agent_name == "Data Analyzer"
...
def test_data_analyzer_performance():
