...
from error_detector import ErrorDetector, ErrorDetectorInput, ErrorDetectorOutput

class TestErrorDetector:
    """Comprehensive test suite for ErrorDetector."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-error-detector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Error Detector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ErrorDetectorOutput)
        assert result.agent_name == "Error Detector"
...
def test_error_detector_performance():
