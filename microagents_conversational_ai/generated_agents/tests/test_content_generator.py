...
from content_generator import ContentGenerator, ContentGeneratorInput, ContentGeneratorOutput
...
class TestContentGenerator:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-content-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ContentGeneratorOutput)
        assert result.agent_name == "Content Generator"
...
def test_content_generator_performance():
