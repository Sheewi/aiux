...
from task_decomposer import TaskDecomposer, TaskDecomposerInput, TaskDecomposerOutput
...
class TestTaskDecomposer:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-task-decomposer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Task Decomposer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, TaskDecomposerOutput)
        assert result.agent_name == "Task Decomposer"
...
def test_task_decomposer_performance():
