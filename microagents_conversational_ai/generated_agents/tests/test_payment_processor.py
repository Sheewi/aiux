...
from payment_processor import PaymentProcessor, PaymentProcessorInput, PaymentProcessorOutput

class TestPaymentProcessor:
    """Comprehensive test suite for PaymentProcessor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-payment-processor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Payment Processor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, PaymentProcessorOutput)
        assert result.agent_name == "Payment Processor"
