...
from content_filter import ContentFilter, ContentFilterInput, ContentFilterOutput

class TestContentFilter:
    """Comprehensive test suite for ContentFilter."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-content-filter-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Content Filter"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ContentFilterOutput)
        assert result.agent_name == "Content Filter"
...
def test_content_filter_performance():
