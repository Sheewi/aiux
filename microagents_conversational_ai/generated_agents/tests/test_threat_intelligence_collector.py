...
from threat_intelligence_collector import ThreatIntelligenceCollector, ThreatIntelligenceCollectorInput, ThreatIntelligenceCollectorOutput

class TestThreatIntelligenceCollector:
    """Comprehensive test suite for ThreatIntelligenceCollector."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-threat-intelligence-collector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Threat Intelligence Collector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ThreatIntelligenceCollectorOutput)
        assert result.agent_name == "Threat Intelligence Collector"
...
class TestThreatIntelligenceCollectorIntegration:
    """Integration tests for ThreatIntelligenceCollector."""
...
def test_threat_intelligence_collector_performance():
