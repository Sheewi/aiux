"""
Test suite for PhishingCampaignManager
...
from phishing_campaign_manager import PhishingCampaignManager, PhishingCampaignManagerInput, PhishingCampaignManagerOutput

class TestPhishingCampaignManager:
    """Comprehensive test suite for PhishingCampaignManager."""
    
    @pytest.fixture
    def agent(self):
        """Create agent instance for testing."""
        return PhishingCampaignManager()
    
    @pytest.fixture
    def valid_input(self):
        """Provide valid input data for testing."""
        return {
            "agent_id": "test-phishing-campaign-manager-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Phishing Campaign Manager"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, PhishingCampaignManagerOutput)
        assert result.agent_name == "Phishing Campaign Manager"
...
class TestPhishingCampaignManagerIntegration:
    """Integration tests for PhishingCampaignManager."""
...
def test_phishing_campaign_manager_performance():
