...
from static_analyzer import StaticAnalyzer, StaticAnalyzerInput, StaticAnalyzerOutput

class TestStaticAnalyzer:
    """Comprehensive test suite for StaticAnalyzer."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-static-analyzer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Static Analyzer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, StaticAnalyzerOutput)
        assert result.agent_name == "Static Analyzer"
...
class TestStaticAnalyzerIntegration:
    """Integration tests for StaticAnalyzer."""
...
def test_static_analyzer_performance():
