...
from event_detector import EventDetector, EventDetectorInput, EventDetectorOutput

class TestEventDetector:
    """Comprehensive test suite for EventDetector."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-event-detector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Event Detector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, EventDetectorOutput)
        assert result.agent_name == "Event Detector"
...
def test_event_detector_performance():
