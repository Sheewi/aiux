"""
Test suite for PenetrationTester
...
from penetration_tester import PenetrationTester, PenetrationTesterInput, PenetrationTesterOutput

class TestPenetrationTester:
    """Comprehensive test suite for PenetrationTester."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-penetration-tester-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Penetration Tester"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, PenetrationTesterOutput)
        assert result.agent_name == "Penetration Tester"
...
class TestPenetrationTesterIntegration:
    """Integration tests for PenetrationTester."""
...
def test_penetration_tester_performance():
