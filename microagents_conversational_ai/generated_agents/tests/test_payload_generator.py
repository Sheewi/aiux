"""
Test suite for PayloadGenerator
...
from payload_generator import PayloadGenerator, PayloadGeneratorInput, PayloadGeneratorOutput

class TestPayloadGenerator:
    """Comprehensive test suite for PayloadGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-payload-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Payload Generator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, PayloadGeneratorOutput)
        assert result.agent_name == "Payload Generator"
...
class TestPayloadGeneratorIntegration:
    """Integration tests for PayloadGenerator."""
...
def test_payload_generator_performance():
