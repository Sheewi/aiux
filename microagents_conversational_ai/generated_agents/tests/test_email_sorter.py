...
from email_sorter import EmailSorter, EmailSorterInput, EmailSorterOutput

class TestEmailSorter:
    """Comprehensive test suite for EmailSorter."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-email-sorter-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Email Sorter"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, EmailSorterOutput)
        assert result.agent_name == "Email Sorter"
...
class TestEmailSorterIntegration:
    """Integration tests for EmailSorter."""
...
def test_email_sorter_performance():
