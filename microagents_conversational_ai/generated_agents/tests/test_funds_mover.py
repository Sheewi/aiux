...
from funds_mover import FundsMover, FundsMoverInput, FundsMoverOutput

class TestFundsMover:
    """Comprehensive test suite for FundsMover."""
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, FundsMoverOutput)
        assert result.agent_name == "Funds Mover"
...
class TestFundsMoverIntegration:
    """Integration tests for FundsMover."""
...
def test_funds_mover_performance():
