"""
Test suite for CampaignManager
...
from campaign_manager import CampaignManager, CampaignManagerInput, CampaignManagerOutput

class TestCampaignManager:
    """Comprehensive test suite for CampaignManager."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-campaign-manager-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Campaign Manager"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, CampaignManagerOutput)
        assert result.agent_name == "Campaign Manager"
...
def test_campaign_manager_performance():
