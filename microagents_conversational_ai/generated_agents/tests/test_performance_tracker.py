...
from performance_tracker import PerformanceTracker, PerformanceTrackerInput, PerformanceTrackerOutput
...
class TestPerformanceTracker:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-performance-tracker-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Performance Tracker"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, PerformanceTrackerOutput)
        assert result.agent_name == "Performance Tracker"
...
def test_performance_tracker_performance():
