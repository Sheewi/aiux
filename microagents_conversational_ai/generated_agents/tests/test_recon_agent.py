...
from recon_agent import ReconAgent, ReconAgentInput, ReconAgentOutput

class TestReconAgent:
    """Comprehensive test suite for ReconAgent."""
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ReconAgentOutput)
        assert result.agent_name == "Recon Agent"
...
def test_recon_agent_performance():
