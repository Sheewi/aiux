...
from health_monitor import HealthMonitor, HealthMonitorInput, HealthMonitorOutput
...
class TestHealthMonitor:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-health-monitor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, HealthMonitorOutput)
        assert result.agent_name == "Health Monitor"
...
def test_health_monitor_performance():
