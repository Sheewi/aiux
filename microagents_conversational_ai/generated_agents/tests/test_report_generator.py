...
from report_generator import ReportGenerator, ReportGeneratorInput, ReportGeneratorOutput
...
class TestReportGenerator:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-report-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ReportGeneratorOutput)
        assert result.agent_name == "Report Generator"
...
def test_report_generator_performance():
