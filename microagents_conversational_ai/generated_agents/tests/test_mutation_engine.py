...
from mutation_engine import MutationEngine, MutationEngineInput, MutationEngineOutput

class TestMutationEngine:
    """Comprehensive test suite for MutationEngine."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-mutation-engine-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Mutation Engine"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, MutationEngineOutput)
        assert result.agent_name == "Mutation Engine"
