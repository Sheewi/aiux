...
from incident_reporter import IncidentReporter, IncidentReporterInput, IncidentReporterOutput

class TestIncidentReporter:
    """Comprehensive test suite for IncidentReporter."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-incident-reporter-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Incident Reporter"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, IncidentReporterOutput)
        assert result.agent_name == "Incident Reporter"
...
class TestIncidentReporterIntegration:
    """Integration tests for IncidentReporter."""
...
def test_incident_reporter_performance():
