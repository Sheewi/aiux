"""
Test suite for IntrusionDetector
...
from intrusion_detector import IntrusionDetector, IntrusionDetectorInput, IntrusionDetectorOutput

class TestIntrusionDetector:
    """Comprehensive test suite for IntrusionDetector."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-intrusion-detector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Intrusion Detector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, IntrusionDetectorOutput)
        assert result.agent_name == "Intrusion Detector"
...
class TestIntrusionDetectorIntegration:
    """Integration tests for IntrusionDetector."""
...
def test_intrusion_detector_performance():
