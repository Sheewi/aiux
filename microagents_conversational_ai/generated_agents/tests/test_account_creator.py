...
from account_creator import AccountCreator, AccountCreatorInput, AccountCreatorOutput

class TestAccountCreator:
    """Comprehensive test suite for AccountCreator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-account-creator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Account Creator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, AccountCreatorOutput)
        assert result.agent_name == "Account Creator"
...
class TestAccountCreatorIntegration:
    """Integration tests for AccountCreator."""
...
def test_account_creator_performance():
