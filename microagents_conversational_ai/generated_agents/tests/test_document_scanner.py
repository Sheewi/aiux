"""
Test suite for DocumentScanner
...
from document_scanner import DocumentScanner, DocumentScannerInput, DocumentScannerOutput

class TestDocumentScanner:
    """Comprehensive test suite for DocumentScanner."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-document-scanner-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Document Scanner"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DocumentScannerOutput)
        assert result.agent_name == "Document Scanner"
...
class TestDocumentScannerIntegration:
    """Integration tests for DocumentScanner."""
...
def test_document_scanner_performance():
