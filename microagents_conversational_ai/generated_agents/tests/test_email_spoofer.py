...
from email_spoofer import EmailSpoofer, EmailSpooferInput, EmailSpooferOutput

class TestEmailSpoofer:
    """Comprehensive test suite for EmailSpoofer."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-email-spoofer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Email Spoofer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, EmailSpooferOutput)
        assert result.agent_name == "Email Spoofer"
...
class TestEmailSpooferIntegration:
    """Integration tests for EmailSpoofer."""
...
def test_email_spoofer_performance():
