...
from website_builder import WebsiteBuilder, WebsiteBuilderInput, WebsiteBuilderOutput

class TestWebsiteBuilder:
    """Comprehensive test suite for WebsiteBuilder."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-website-builder-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Website Builder"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, WebsiteBuilderOutput)
        assert result.agent_name == "Website Builder"
...
def test_website_builder_performance():
