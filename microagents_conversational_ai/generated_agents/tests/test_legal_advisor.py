...
from legal_advisor import LegalAdvisor, LegalAdvisorInput, LegalAdvisorOutput

class TestLegalAdvisor:
    """Comprehensive test suite for LegalAdvisor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-legal-advisor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Legal Advisor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, LegalAdvisorOutput)
        assert result.agent_name == "Legal Advisor"
...
class TestLegalAdvisorIntegration:
    """Integration tests for LegalAdvisor."""
...
def test_legal_advisor_performance():
