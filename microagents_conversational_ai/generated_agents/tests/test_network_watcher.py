...
from network_watcher import NetworkWatcher, NetworkWatcherInput, NetworkWatcherOutput

class TestNetworkWatcher:
    """Comprehensive test suite for NetworkWatcher."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-network-watcher-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Network Watcher"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, NetworkWatcherOutput)
        assert result.agent_name == "Network Watcher"
...
class TestNetworkWatcherIntegration:
    """Integration tests for NetworkWatcher."""
...
def test_network_watcher_performance():
