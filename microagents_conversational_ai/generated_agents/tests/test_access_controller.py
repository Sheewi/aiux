...
from access_controller import AccessController, AccessControllerInput, AccessControllerOutput
...
class TestAccessController:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-access-controller-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Access Controller"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, AccessControllerOutput)
        assert result.agent_name == "Access Controller"
...
def test_access_controller_performance():
