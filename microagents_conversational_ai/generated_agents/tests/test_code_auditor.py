...
from code_auditor import CodeAuditor, CodeAuditorInput, CodeAuditorOutput

class TestCodeAuditor:
    """Comprehensive test suite for CodeAuditor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-code-auditor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Code Auditor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, CodeAuditorOutput)
        assert result.agent_name == "Code Auditor"
...
class TestCodeAuditorIntegration:
    """Integration tests for CodeAuditor."""
...
def test_code_auditor_performance():
