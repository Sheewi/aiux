...
from anomaly_detector import AnomalyDetector, AnomalyDetectorInput, AnomalyDetectorOutput
...
class TestAnomalyDetector:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-anomaly-detector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Anomaly Detector"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, AnomalyDetectorOutput)
        assert result.agent_name == "Anomaly Detector"
