"""
Test suite for CredentialSprayer
...
from credential_sprayer import CredentialSprayer, CredentialSprayerInput, CredentialSprayerOutput

class TestCredentialSprayer:
    """Comprehensive test suite for CredentialSprayer."""
    
    @pytest.fixture
    def agent(self):
        """Create agent instance for testing."""
        return CredentialSprayer()
    
    @pytest.fixture
    def valid_input(self):
        """Provide valid input data for testing."""
        return {
            "agent_id": "test-credential-sprayer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Credential Sprayer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, CredentialSprayerOutput)
        assert result.agent_name == "Credential Sprayer"
...
class TestCredentialSprayerIntegration:
    """Integration tests for CredentialSprayer."""
...
def test_credential_sprayer_performance():
