...
from script_generator import ScriptGenerator, ScriptGeneratorInput, ScriptGeneratorOutput

class TestScriptGenerator:
    """Comprehensive test suite for ScriptGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-script-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Script Generator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ScriptGeneratorOutput)
        assert result.agent_name == "Script Generator"
...
class TestScriptGeneratorIntegration:
    """Integration tests for ScriptGenerator."""
...
def test_script_generator_performance():
