...
from web_scraper import WebScraper, WebScraperInput, WebScraperOutput

class TestWebScraper:
    """Comprehensive test suite for WebScraper."""
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert result.agent_name == "Web Scraper"
...
def test_web_scraper_performance():
