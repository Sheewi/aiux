...
from data_downloader import DataDownloader, DataDownloaderInput, DataDownloaderOutput

class TestDataDownloader:
    """Comprehensive test suite for DataDownloader."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-data-downloader-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Data Downloader"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DataDownloaderOutput)
        assert result.agent_name == "Data Downloader"
...
class TestDataDownloaderIntegration:
    """Integration tests for DataDownloader."""
...
def test_data_downloader_performance():
