...
from load_balancer import LoadBalancer, LoadBalancerInput, LoadBalancerOutput
...
class TestLoadBalancer:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-load-balancer-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Load Balancer"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, LoadBalancerOutput)
        assert result.agent_name == "Load Balancer"
