"""
Test suite for ShellcodeCompiler
...
from shellcode_compiler import ShellcodeCompiler, ShellcodeCompilerInput, ShellcodeCompilerOutput

class TestShellcodeCompiler:
    """Comprehensive test suite for ShellcodeCompiler."""
    
    @pytest.fixture
    def agent(self):
        """Create agent instance for testing."""
        return ShellcodeCompiler()
    
    @pytest.fixture
    def valid_input(self):
        """Provide valid input data for testing."""
        return {
            "agent_id": "test-shellcode-compiler-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Shellcode Compiler"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, ShellcodeCompilerOutput)
        assert result.agent_name == "Shellcode Compiler"
...
class TestShellcodeCompilerIntegration:
    """Integration tests for ShellcodeCompiler."""
...
def test_shellcode_compiler_performance():
