...
from task_manager import TaskManager, TaskManagerInput, TaskManagerOutput

class TestTaskManager:
    """Comprehensive test suite for TaskManager."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-task-manager-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, TaskManagerOutput)
        assert result.agent_name == "Task Manager"
