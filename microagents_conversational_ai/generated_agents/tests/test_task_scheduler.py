...
from task_scheduler import TaskScheduler, TaskSchedulerInput, TaskSchedulerOutput
...
class TestTaskScheduler:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-task-scheduler-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Task Scheduler"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, TaskSchedulerOutput)
        assert result.agent_name == "Task Scheduler"
...
def test_task_scheduler_performance():
