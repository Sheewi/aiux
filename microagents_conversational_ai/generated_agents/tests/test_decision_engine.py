...
from decision_engine import DecisionEngine, DecisionEngineInput, DecisionEngineOutput
...
class TestDecisionEngine:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-decision-engine-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Decision Engine"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert result.agent_name == "Decision Engine"
