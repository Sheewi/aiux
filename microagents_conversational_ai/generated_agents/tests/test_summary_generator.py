...
from summary_generator import SummaryGenerator, SummaryGeneratorInput, SummaryGeneratorOutput

class TestSummaryGenerator:
    """Comprehensive test suite for SummaryGenerator."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-summary-generator-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Summary Generator"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, SummaryGeneratorOutput)
        assert result.agent_name == "Summary Generator"
...
def test_summary_generator_performance():
