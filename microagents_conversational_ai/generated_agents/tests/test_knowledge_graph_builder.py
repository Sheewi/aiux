...
from knowledge_graph_builder import KnowledgeGraphBuilder, KnowledgeGraphBuilderInput, KnowledgeGraphBuilderOutput

class TestKnowledgeGraphBuilder:
    """Comprehensive test suite for KnowledgeGraphBuilder."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-knowledge-graph-builder-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Knowledge Graph Builder"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, KnowledgeGraphBuilderOutput)
        assert result.agent_name == "Knowledge Graph Builder"
...
def test_knowledge_graph_builder_performance():
