...
from market_analyst import MarketAnalyst, MarketAnalystInput, MarketAnalystOutput

class TestMarketAnalyst:
    """Comprehensive test suite for MarketAnalyst."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-market-analyst-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
...
def test_market_analyst_performance():
