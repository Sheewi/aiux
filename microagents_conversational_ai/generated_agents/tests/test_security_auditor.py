...
from security_auditor import SecurityAuditor, SecurityAuditorInput, SecurityAuditorOutput

class TestSecurityAuditor:
    """Comprehensive test suite for SecurityAuditor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-security-auditor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, SecurityAuditorOutput)
        assert result.agent_name == "Security Auditor"
...
def test_security_auditor_performance():
