...
from health_checker import HealthChecker, HealthCheckerInput, HealthCheckerOutput
...
class TestHealthChecker:
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-health-checker-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Health Checker"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, HealthCheckerOutput)
        assert result.agent_name == "Health Checker"
