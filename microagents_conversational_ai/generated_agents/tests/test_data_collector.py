...
from data_collector import DataCollector, DataCollectorInput, DataCollectorOutput

class TestDataCollector:
    """Comprehensive test suite for DataCollector."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-data-collector-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, DataCollectorOutput)
        assert result.agent_name == "Data Collector"
...
def test_data_collector_performance():
