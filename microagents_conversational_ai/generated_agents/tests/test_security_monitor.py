...
from security_monitor import SecurityMonitor, SecurityMonitorInput, SecurityMonitorOutput

class TestSecurityMonitor:
    """Comprehensive test suite for SecurityMonitor."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-security-monitor-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_initialization(self, agent):
        ...
        assert agent.name == "Security Monitor"
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, SecurityMonitorOutput)
        assert result.agent_name == "Security Monitor"
