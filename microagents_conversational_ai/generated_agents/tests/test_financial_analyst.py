"""
Test suite for FinancialAnalyst
...
from financial_analyst import FinancialAnalyst, FinancialAnalystInput, FinancialAnalystOutput

class TestFinancialAnalyst:
    """Comprehensive test suite for FinancialAnalyst."""
    ...
    def valid_input(self):
        ...
        return {
            "agent_id": "test-financial-analyst-001",
            "timeout": 30,
            "priority": 5,
            "metadata": {"test": True}
        }
    ...
    def test_valid_input_execution(self, agent, valid_input):
        ...
        assert isinstance(result, FinancialAnalystOutput)
...
class TestFinancialAnalystIntegration:
    """Integration tests for FinancialAnalyst."""
...
def test_financial_analyst_performance():
