# Implementation Guide for Data Exfiltration Simulator

## Core Logic Implementation
- [ ] Implement _process() method with domain-specific logic
- [ ] Define agent-specific input validation beyond Pydantic models
- [ ] Add error cases specific to data exfiltration simulator operations
...
- [ ] Add custom metrics relevant to data exfiltration simulator
